      ...
      <div className="relative z-10 w-full max-w-md mx-4">
        <div className="border border-border rounded-sm bg-card/80 p-8 backdrop-blur-sm">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-primary bg-primary/10 text-primary rounded-sm font-display text-xs uppercase tracking-widest hover:bg-primary/20 hover:shadow-[0_0_20px_hsl(var(--primary)/0.3)] transition-all"
          >
